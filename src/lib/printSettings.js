...
// ══════════════════════════════════════════════════════════════
//  printSettings — إعدادات الطباعة الموحّدة (V13.7.7)
//
...
/** قراءة الإعدادات (مع كاش لكل صفحة) */
export async function getPrintSettings(force = false) {
