...
export default function Admin() {
  ...
  const MENU_GROUPS = [
    ...
    { key: 'catalogue', icon: '🗂️', label: 'الكتالوج والمحتوى', children: ['catalog', 'illus', 'warranty', 'ticker'] },
    ...
    { key: 'systemPrefs', icon: '⚙️', label: 'تفضيلات النظام', children: ['printing', 'sounds'] },
