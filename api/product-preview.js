...
export default async function handler(request, response) {
  ...
  response.status(200).send(page({ title, description, image, url: `${origin}${requestedPath}`, isProduct }));
}
