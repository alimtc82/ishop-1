## V15.5.7 — ربط عميل الأرشفة وتحديث ضمان الجهاز المستعمل
- إخفاء واجهة التنقل والخلفية بالكامل أثناء فتح مودال الأرشفة لضمان التركيز على العملية.
- الحفاظ على البحث الجزئي بالاسم ورقم الهاتف والاختيار والملء التلقائي للعملاء الحاليين.
- إضافة تنبيه متأخر للرقم غير المسجل مع خيار إضافة العميل أو تجاهل التنبيه.
- إضافة زر سريع بجوار اسم المشتري لإنشاء عميل مع تعبئة الاسم والهاتف واختياره وربطه تلقائيًا.
- منع تكرار العميل عند اكتشاف رقم هاتف مسجل واختيار السجل الموجود بدلًا منه.
- إضافة نص ضمان 30 يومًا وشروط الضمان ورابط المتابعة والختام إلى إيصال A4 والإيصال الحراري.
- لم يتم تعديل Supabase schema أو RLS أو migrations.
