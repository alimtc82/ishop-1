...
import { createUser, updateUserRow, setUserEmail, setDeletePass, updateUserByUsername, setUserPassword, fetchUserBranchAccess, setUserBranchAccess } from '../lib/adminApi';
  ...
  async function save() {
    ...
    try {
      if (!isEdit) {
        ...
        if (createdId) await setUserBranchAccess(createdId, allowedBranches, branch);
        show('✅ تم إنشاء المستخدم وربط الفروع');
      } else {
        // ── تعديل ──
